...
void InitEPwmGpio(void)
{
    ...
    InitEPwm1Gpio();//buck boost sourcing side 1
    InitEPwm2Gpio();//buck boost sourcing side 2
    InitEPwm3Gpio();//buck boost sourcing side 3
    InitEPwm4Gpio();//buck boost sinking side 1
    InitEPwm5Gpio();//buck boost sinking side 2
    InitEPwm6Gpio();//buck boost sinking side 3
#endif

    InitEPwm7Gpio();//SRC based on full bridge
    InitEPwm8Gpio();//SRC based on full bridge

    //InitEPwm9Gpio();//reserved

    InitEPwm10Gpio();//inverter R
    InitEPwm11Gpio();//inverter S
    InitEPwm12Gpio();//inverter T
}
...
void InitEPwm2Gpio(void)
{
    ...
    GpioCtrlRegs.GPAPUD.bit.GPIO2 = 1; // Disable pull-up on GPIO2 (EPWM2A)      190802
    ...
    GpioCtrlRegs.GPAMUX1.bit.GPIO2 = 1; // Configure GPIO2 as EPWM2A      190802
...
void InitEPwm4Gpio(void)
{
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAPUD.bit.GPIO6 = 1; // Disable pull-up on GPIO6 (EPWM4A)    190802
    ...
    // Comment out other unwanted lines.
    //
    GpioCtrlRegs.GPAMUX1.bit.GPIO6 = 1;  // Configure GPIO6 as EPWM4A     190802
...
//    GpioCtrlRegs.GPFPUD.bit.GPIO162 = 1;    // Disable pull-up on GPIO162 (EPWM9B)
    ...
    //   GpioCtrlRegs.GPAPUD.bit.GPIO16 = 1;    // Disable pull-up on GPIO161 (EPWM9A)
    //  GpioCtrlRegs.GPAPUD.bit.GPIO17 = 1;    // Disable pull-up on GPIO162 (EPWM9B)
...
//    GpioCtrlRegs.GPFPUD.bit.GPIO166 = 1;    // Disable pull-up on GPIO166 (EPWM11B)
    GpioCtrlRegs.GPAPUD.bit.GPIO20 = 1;  // Disable pull-up on GPIO163 (EPWM11A)
    GpioCtrlRegs.GPAPUD.bit.GPIO21 = 1;  // Disable pull-up on GPIO164 (EPWM11B)
...
//    GpioCtrlRegs.GPFMUX1.bit.GPIO166 = 1;   // Configure GPIO166 as EPWM11B
    ...
    GpioCtrlRegs.GPAMUX2.bit.GPIO20 = 1;   // Configure GPIO163 as EPWM11A
    GpioCtrlRegs.GPAMUX2.bit.GPIO21 = 1;   // Configure GPIO164 as EPWM11B
...
//    GpioCtrlRegs.GPFPUD.bit.GPIO168 = 1;    // Disable pull-up on GPIO168 (EPWM12B)
    ...
    GpioCtrlRegs.GPAPUD.bit.GPIO22 = 1;  // Disable pull-up on GPIO163 (EPWM11A)
    GpioCtrlRegs.GPAPUD.bit.GPIO23 = 1;  // Disable pull-up on GPIO164 (EPWM11B)
...
//    GpioCtrlRegs.GPFMUX1.bit.GPIO168 = 1;   // Configure GPIO168 as EPWM12B
    ...
    GpioCtrlRegs.GPAMUX2.bit.GPIO22 = 1;   // Configure GPIO163 as EPWM12A
    GpioCtrlRegs.GPAMUX2.bit.GPIO23 = 1;   // Configure GPIO164 as EPWM12B
