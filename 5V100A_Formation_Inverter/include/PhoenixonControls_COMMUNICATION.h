...
#define CH_NUMBER 0x01

#define MULTI 10000.0

 #define DEV_LOG
//#define DEV_SCHEDULE                                                                                                 //Gateway                 192,168,  0,  1
...
//Device
#define COMMUNICATION_CHANNEL                       (2)         //MAX 4 Channel
#define COMMUNICATION_CHANNEL_NUMBER                (1)         //device id 0~3 total 4 Channel
...
#ifdef DEV_SCHEDULE
#define COMMUNICATION_INTEGER_LENGTH_STEP_PACKET    (12)//(1) + (7) + (4)
#else
...
typedef enum
{
	...
	INDEX_RETURN			= 7,
	INDEX_JUMP              = 8, // 한번반
	INDEX_PAUSE_COMPLETE    = 9, // 한번만
	INDEX_ALARM             = 10,
	INDEX_PAUSE_PAUSE       = 11, // 계속들어가야하고.
	INDEX_STEP_END          = 0xFFFF,
}E_COMMUNICATION_STEP_INDEX;

// I/F로부터 8개의 스텝정보를 읽어오는데 이값으로 배열의 값을 읽어오게 되어있다.
...
typedef struct
{
    ...
    Uint16 LOOP_COUNT;  // Cell Cycler쪽에서 추가함, 인터페이스에서도 추가됨.
#endif
...
#if 0// 추가.
    Uint16 CPU1_Currentx16;
    Uint16 CPU1_Currentx00;
    Uint16 CPU1_Voltagex16;
    Uint16 CPU1_Voltagex00;
    Uint16 CPU1_Capacityx16;
    Uint16 CPU1_Capacityx00;
    Uint16 CPU1_Wattx16;
    Uint16 CPU1_Wattx00;
    Uint16 CPU1_Parallel_StepIndex;//추가
    Uint16 CPU1_Parallel_CMD[8];
#endif
...
typedef struct
{
    ...
    Uint16 CPU2_Pause;
    Uint16 CPU2_Alarm;
    //Uint16 CPU2_Parallel_CMD[8];

    Uint16 CPU2_StepIndex;
    //Uint16 CPU2_test_StepIndex;
...
typedef struct
{
    Uint16 CPU2_Currentx16;
    Uint16 CPU2_Currentx00;
    Uint16 CPU2_Voltagex16;
    Uint16 CPU2_Voltagex00;
    Uint16 CPU2_Capacityx16;
    Uint16 CPU2_Capacityx00;
    Uint16 CPU2_Wattx16;
    Uint16 CPU2_Wattx00;

}S_COMMUNICATON_SMALL_DATA_CPU2;
